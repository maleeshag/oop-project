...
<div  class="container" style="background-color: lightgrey;width: auto;padding: 40px;margin-right:150px;margin-left:150px;margin-bottom: auto;margin-top:40px">
   ...
   <div class="text-center"  style="margin-top:20px;margin-bottom:60;" ><h1 ><b>Delete Feedback</b></h1></div>
   ...
   <div class="col-md-10" >
    ...
    <input type="text" class="form-control" id="FeedbackId" name="feedbackid"  value="<%= feedbackid  %>" readonly  >

   <label for="coustomerID">Customer Name</label>
   <input type="text"  class="form-control" id ="coustomerID" name="coustomerID"  value="<%= coustomerID  %>" readonly  >

   
    <label for="validationTextarea ">Feedback Title</label>
   <textarea class="form-control is-invalid" id="validationTextarea" name="feedback" placeholder="Required example textarea" readonly>    <%= feedback  %></textarea>
		...
		<input type="hidden" name="feedbackrate" id="example" readonly >
		</div> 
      
      
      
      <button  onclick="result()" type="submit" style="margin-top:10px;margin-left:5px;" class="btn btn-primary"  name="deletefeedback" >Delete</button>
