...
<div class="text-center"  style="margin-top:20px;" ><h1 ><b>Insert Feedback</b></h1></div>
    


 <form class="was-validated" action="log" method="post">
  <div class="form-coulmn">
   ...
   <div class="mb-3">
      ...
      <input type="text" class="form-control"  name="coustomerID" required >
   </div>
   <br>
   <br>
   ...
   <div class="mb-3">
    ...
    <textarea class="form-control is-invalid" id="validationTextarea" name="feedback" placeholder="Required example textarea" required></textarea>
  ...
  <br>
   <br> 
      ...
      <button  onclick="result()" type="submit" style="margin-top:10px;margin-left:5px;" class="btn btn-dark"  name="createfeedback" >Submit</button>
